...
const CTASection = () => {
  return (
    <section className="py-16 md:py-20 relative overflow-hidden">
      ...
      {/* Elementos de fundo */}
      <div className="absolute -top-40 -right-40 w-80 h-80 bg-mk-accent/20 rounded-full blur-[100px] animate-pulse"></div>
      <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-mk-accent/20 rounded-full blur-[100px] animate-pulse"></div>
